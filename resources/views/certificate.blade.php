...
<div class="certificate">
    ...
    <div class="certificate__content">
        <div class="certificate__content-t">
            Участника проекта многосерийного кинофильма «Шейх Шамиль» <br>выдаётся <span>{{$contributor->getFio()}}</span> (ФИО) <br>из <span>{{$contributor->city}} </span>(страна/населенный пункт)</div>
